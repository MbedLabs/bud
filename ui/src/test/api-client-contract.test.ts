...
const CALLS: Array<[string, unknown[], string, string]> = [
  ...
  ['groupsApi.remove', [3], 'delete', '/groups/3'],
  ['groupsApi.addMember', [3, 7], 'post', '/groups/3/members'],
  ['groupsApi.removeMember', [3, 7], 'delete', '/groups/3/members/7'],
  ['groupsApi.addGrant', [3, null], 'post', '/groups/3/grants'],
  ['groupsApi.removeGrant', [3, 9], 'delete', '/groups/3/grants/9'],
